...
public class CallTableUpdate extends CallProcUpdate
{
    ...
    @Override
    public void callUpdateProc(String procNm, Object... args)
            throws SQLException
    {
    ...
    public void callUpdateTable(String procNm, Object... args)
            throws SQLException
    {
        ...
        } catch (SQLException var27)
        {
            ...
            {
                dbMessage = var27.getErrorCode() + " CallProcUpdate:"
                        + debugProcCall + " SQLException " + var27.getMessage();
                dbError = true;
            }
        ...
        } catch (Exception var28)
        {
            dbMessage = "Unknown Exception " + this.getClass().getName() + ": "
                    + debugProcCall + var28.getMessage();
            dbError = true;
        ...
        } finally
        {
            if (dbConn != null)
            {
                ...
                {
                    System.out
                            .println("Connection close " + var25.getMessage());
                }
            }
