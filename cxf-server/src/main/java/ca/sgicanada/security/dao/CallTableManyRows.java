...
public class CallTableManyRows extends CallProcManyRows
{
	...
	public ArrayList<HashMap<String, Object>> callTable(String procNm, Object... args) throws SQLException
	{
		...
		try
		{
			...
			if (found)
			{
				...
				do
				{
					...
					++idx;
					HashMap<String, Object> rowHashMap = rsMany.get(idx);
					int i;
					for (i = 1; i <= colCount; ++i)
					{
						...
						if (metaData.getColumnType(i) != -1 && metaData.getColumnType(i) != 1
								&& metaData.getColumnType(i) != 12)
						{
							if (metaData.getColumnType(i) != 4 && metaData.getColumnType(i) != 5
		...
		{
			dbMessage = var42.getErrorCode() + " CallProcManyRows:" + debugProcCall + " SQLException "
					+ var42.getMessage();
			dbError = true;
			throw var42;
	...
	private NamedParameterStatement createNamedParameterStatement(Connection dbConn, String procNm, Object... args)
	{
		...
		case "s_oauth_usersubject":
			...
			System.out.println("args[0] " + String.valueOf(args[0]));
			System.out.println("args[1] " + String.valueOf(args[1]));
			...
			try
			{
				...
				{
					nstmt.setNull("id", java.sql.Types.VARCHAR);
				...
				{
					nstmt.setNull("login", java.sql.Types.VARCHAR);
