...
public class ClientAppRegistrationService
{
  ...
  // @GET
  // @Path("/ClientAppRegistration.jsp")
  // @Produces("text/html")
  // public String getClient(Model model)
  // {
  // return "/ClientAppRegistration.jsp" ;
  // }
  ...
  {
    System.out.println("registerClientApps") ;
  ...
  @Path("/registerClientApp")
  public void registerForm(@FormParam("appName") String appName, @FormParam("appDesc") String appDesc, @FormParam("appURI") String appURI, @FormParam("appRedirectURI") String appRedirectURI)
  {
  ...
  {
    System.out.println("registerClientApp") ;
