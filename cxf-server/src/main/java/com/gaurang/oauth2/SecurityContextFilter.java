...
public class SecurityContextFilter implements ContainerRequestFilter
{
    ...
    public void setClientAppRegistrationService(
            ClientAppRegistrationService clientAppRegistrationService)
    {
            ...
            throws IOException
    {
        ...
        for (String s : namePassword)
        {
            System.out.println("namePassword : " + s);
        }
    ...
    private boolean checkAuthenticity(String userId, String password)
    {
        ...
        if ((user == null && client == null))
        {
            return false;
                ...
                || (client != null && !client.getClientSecret()
                        .equals(password)))
        {
            return false;
        } else
    ...
    private Response createFaultResponse()
    {
        return Response
                ...
                .header("WWW-Authenticate",
                        "Basic realm=\"oauth2.gaurang.com\"").build();
    }
