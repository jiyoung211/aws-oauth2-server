...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h2>WebService Client Request Message</h2>
      
  	  <textarea class="form-control col" rows="5">${req}</textarea>
      
  	  <h2>WebService Client Response Message</h2>
      
	  <textarea class="form-control col" rows="5">${res}</textarea>
	</div>	
    <div class="container mt-5">
      ...
      <div class="card-deck mb-3 text-center">
        <div class="card mb-6 box-shadow">
          ...
          <div class="card-body">
            <p class="card-text">Send SOAPMessage</p>
			<textarea class="form-control " rows="5">${reqSoapMessage}</textarea>
			<p class="card-text">Receive SOAPMessage</p>
			<textarea class="form-control " rows="5">${resSoapMessage}</textarea> 
          </div>
        </div>
        <div class="card mb-6 box-shadow">
          <div class="card-header">
          ...
          <div class="card-body">
            <p class="card-text">Receive SOAPMessage</p>
			<textarea class="form-control " rows="5">${reqSoapMessageServer}</textarea>
			<p class="card-text">Send SOAPMessage</p>
			<textarea class="form-control " rows="5">${resSoapMessageServer}</textarea>
          </div>
        </div>
      </div>
