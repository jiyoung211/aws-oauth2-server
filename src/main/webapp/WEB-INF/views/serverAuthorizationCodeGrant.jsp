...
<%@ page import="java.util.*,javax.servlet.http.HttpServletRequest,org.apache.cxf.rs.security.oauth2.common.OAuthAuthorizationData,org.apache.cxf.rs.security.oauth2.common.OAuthPermission,org.apache.cxf.rs.security.oauth2.grants.code.ServerAuthorizationCodeGrant" %>
...
<%
	...
	ServerAuthorizationCodeGrant data = (ServerAuthorizationCodeGrant)request.getAttribute("data");
%>
