       ...
       <table>    
        ...
        <tr>
            <td colspan="2">
                ...
                <input type="button" value="    client    " onclick="location.href='/oauth2/client'"/>
                <input type="button" value="    oauthauthorization    " onclick="location.href='http://localhost:7070/services/authorize?response_type=code&client_id=ClientApp&scope=apiAccess+refreshToken&state=1&userSubjectId=null'"/>
