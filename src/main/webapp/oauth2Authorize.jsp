...
<%@ page import="java.util.*,javax.servlet.http.HttpServletRequest,org.apache.cxf.rs.security.oauth2.common.OAuthAuthorizationData,org.apache.cxf.rs.security.oauth2.common.OAuthPermission" %>

<%
    OAuthAuthorizationData data = (OAuthAuthorizationData)request.getAttribute("oauthauthorizationdata");
String data1 = (String)request.getAttribute("absolute.path");
