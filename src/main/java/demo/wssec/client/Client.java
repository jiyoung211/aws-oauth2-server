...
public final class Client
{
    ...
    public Map<String, String> callMain(String operation, String requestParam)
            throws Exception
    {
        ...
        try
        {
            ...
            // add
            Map<String, Object> loggingProps = new HashMap<String, Object>();
            ...
            client.getEndpoint().getInInterceptors()
                    .add(new SaveLoggingInInterceptor());
            client.getEndpoint().getOutInterceptors()
                    .add(new SaveLoggingOutInterceptor());
            ...
            String reqSoapMessage = new String(
                    "SaveLoggingInInterceptor Not found ");
            String resSoapMessage = new String(
                    "SaveLoggingOutInterceptor Not found ");
            String reqSoapMessageServer = new String(
                    "SaveLoggingInInterceptor Not found ");
            String resSoapMessageServer = new String(
                    "SaveLoggingOutInterceptor Not found ");

            List<Interceptor<? extends Message>> outInterceptors = client
                    .getOutInterceptors();
            ...
            List<Interceptor<? extends Message>> inInterceptors = client
                    .getInInterceptors();
