...
public class CallTableUpdate extends CallProcUpdate
{
  ...
  public void callUpdateTable(String procNm, Object... args) throws SQLException
  {
    ...
    try
    {
      ...
      if (dbConn == null)
      {
        ...
        // log.error(this.getClass() + " could not retrieve connection.") ;
    ...
    catch (SQLException var27)
    {
      ...
      {
        dbMessage = var27.getErrorCode() + " CallProcUpdate:" + debugProcCall + " SQLException " + var27.getMessage() ;
        dbError = true ;
      }
  ...
  private NamedParameterStatement createNamedParameterStatement(Connection dbConn, String procNm, Object... args)
  {
    ...
    case "i_oauth_usersubject" :
      // userSubject.getId(), userSubject.getAuthenticationMethod() != null ?
      ...
      try
      {
        ...
        nstmt.setInt("authenticationmethod", (int) args[1]) ;
